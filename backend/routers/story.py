...
def get_session_id(session_id: Optional[str] = Cookie(None)):
    """
    Takes in session_id , which is optional string type , a cookie = None
    Note: Session will identify in your browser when you're interacting with a website, sessions can expire after a
    certain amount of time, but they can store information about the session itself.
    :param session_id:
    :return:
    """
    if not session_id:
...
def generate_story_task(job_id: str, theme: str, session_id: str):
    db = SessionLocal()  # this is a new session.
    try:
